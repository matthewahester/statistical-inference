# CLAUDE.md — statistical-inference (public Quarto site)
...
**Statistical Inference** course assembled by Matt Hester. It is a
sibling of the main site [matthewhester.com](https://matthewhester.com)
and is intended to live at `/statistical-inference/` under that domain,
alongside the other course sites.

It holds **assembled undergraduate course material** — the course's own
synthesized notes, hands-on simulation labs, and curated resources.
...
- Source mirrors of MIT OCW 18.05, ModernDive, or Introduction to Modern
  Statistics, or per-chapter extracts/indexes. Cite at the section
  level; do not reproduce source text wholesale.
